...
public class JprnpLista01Ex08 {
    ...
    static int n = NAIPE.length * NIVEL.length;
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        while((pbust == false) && done == false) {
            ...
            while(true){
                if(("S".equals(answer)) || ("s".equals(answer))) {
                    ...
                    if(playerpts > 21) {
                        System.out.println("Voce estourou! Total de pontos: "
                                                                  + playerpts);
                        pbust = true;
                    }
                    break;
        ...
        if(dealerpts > 21) {
            dbust = true;
            System.out.println("Dealer Estourou! Total de Pontos: " 
                                                                   + dealerpts);
        }
